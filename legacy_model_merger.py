...
class BaseModelMerger(ABC):
    ...
    def save_hf_model_and_tokenizer(self, state_dict: dict[str, torch.Tensor]):
        ...
        processor = AutoProcessor.from_pretrained(self.hf_model_config_path)
        try:
            tokenizer = AutoTokenizer(self.hf_model_config_path)
...
def main():
    ...
    base_op_parser.add_argument("--local_dir", type=str, default="outputs/rllava/qwen2_5_vl_3b_agent_search_online2/checkpoints/global_step_400/actor", help="Path to the saved model checkpoints")
    base_op_parser.add_argument(
        "--hf_model_path",
        type=str,
        default="../huggingface_cache/hub/models--Qwen--Qwen2.5-VL-3B-Instruct/snapshots/66285546d2b821cf421d4f5eb2576359d3770cd3",
    ...
    merge_parser.add_argument(
        "--target_dir", default="outputs/rllava/qwen2_5_vl_3b_agent_search_online2/checkpoints/global_step_400/merged", type=str, help="Directory to save the merged huggingface model"
    )
    merge_parser.add_argument(
