...
import dataclasses
from rllava.utils.dist_utils import is_rank0, dist_rank0
...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "console" in default_backend:
            from rllava.utils.logger.aggregate_logger import LocalLogger
...
class _TensorboardAdapter:
    def __init__(self, project, name):
        ...
        if tensorboard_dir == "tensorboard_log":
            tensorboard_dir = os.path.join(
                tensorboard_dir, project, name
            )
        else:
            tensorboard_dir = os.path.join(
                tensorboard_dir, project, name, "tensorboard_log"
            )
