...
MODEL_NAME="tinyllava-qwen2-vl-2b-clevr-70k-vllm"
MODEL_PATH=f"/mnt/ve_share/zhaolei/outputs/{MODEL_NAME}/checkpoint-100" # Qwen2vl-2b-Instruct for original scores
BSZ=64 # reduce it if GPU OOM
OUTPUT_PATH=f"./logs/{MODEL_NAME}_100.json"
DATA_ROOT="/mnt/ve_share/zhaolei/data/superCLEVR"
PROMPT_PATH=f"{DATA_ROOT}/prompts/superclevr_test200_counting_problems.jsonl"
...
for i in data:
    ...
    image_path = image_path.replace("./images", f"{DATA_ROOT}/images")
    message = [{
        "role": "user",
        "content": [
            {
