...
LLM_VERSION=/mnt/ve_share/zhaolei/.cache/huggingface/hub/Qwen/Qwen3-0.6B # llm path in huggingface
...
VERSION=qwen3-0.6b #experiment name for recording different runnings
