...
LLM_VERSION=/mnt/ve_share/zhaolei/.cache/huggingface/hub/Qwen/Qwen3-1.7B-Base # llm path in huggingface
...
VERSION=qwen3-1.7b-base #experiment name for recording different runnings
