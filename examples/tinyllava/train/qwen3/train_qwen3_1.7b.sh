...
LLM_VERSION=/mnt/ve_share/zhaolei/.cache/huggingface/hub/Qwen/Qwen3-1.7B # llm path in huggingface
...
VERSION=qwen3-1.7b #experiment name for recording different runnings
