...
LLM_VERSION=/mnt/ve_share/zhaolei/.cache/huggingface/hub/Qwen/Qwen3-4B-Thinking-2507 # llm path in huggingface
...
VERSION=qwen3-4b-thinking #experiment name for recording different runnings
