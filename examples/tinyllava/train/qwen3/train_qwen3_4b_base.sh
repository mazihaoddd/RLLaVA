...
LLM_VERSION=/mnt/ve_share/zhaolei/.cache/huggingface/hub/Qwen/Qwen3-4B-Base # llm path in huggingface
...
VERSION=qwen3-4b-base #experiment name for recording different runnings
